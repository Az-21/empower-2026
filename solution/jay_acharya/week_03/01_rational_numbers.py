...
def make_rational(numerator_value: int, denominator_value: int) -> RationalNumber:
    """Constructor. Must reduce to lowest terms and normalize the sign."""
...
def add_rational(
    ...
    new_denominator = (
        denominator(first_rational)
        * denominator(second_rational)
    )
...
def multiply_rational(
    ...
    """first_rational * second_rational."""
    new_numerator = (
        numerator(first_rational)
        * numerator(second_rational)
    )
...
def equal_rational(
    ...
    return (
        ...
        and denominator(first_rational) == denominator(second_rational)
    )
...
def is_bill_fully_claimed(shares: list[RationalNumber]) -> bool:
    """True if total_claimed_share(shares) equals exactly one whole."""

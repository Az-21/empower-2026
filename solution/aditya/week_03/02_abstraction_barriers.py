...
#    Money values created by the constructor and values returned by the
#    selector functions.
#
...
#    would not?
#    Layer 0 and Layer 1 would need to change because they contain the
#    representation and the constructor/selectors. Layer 2 and Layer 3
#    would not need to change because they use the abstraction interface.
#
...
#    It belongs to Layer 2 because it is testing the add_money operation.
#

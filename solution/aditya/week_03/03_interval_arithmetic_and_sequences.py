...
def multiply_interval(
  ...
  product_1 = lower_bound(first_interval) * lower_bound(second_interval)
  product_2 = lower_bound(first_interval) * upper_bound(second_interval)
  product_3 = upper_bound(first_interval) * lower_bound(second_interval)
  product_4 = upper_bound(first_interval) * upper_bound(second_interval)

  return make_interval(
    min(product_1, product_2, product_3, product_4),
    max(product_1, product_2, product_3, product_4),
  )
...
def divide_interval(
  ...
  reciprocal_interval = make_interval(

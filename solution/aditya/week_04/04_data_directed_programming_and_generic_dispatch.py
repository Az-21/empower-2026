...
def install_standard_package() -> None:
  ...
  def standard_delivery(contents: dict[str, float]) -> int:
    return 5
...
def install_express_package() -> None:
  ...
  def express_delivery(contents: dict[str, float]) -> int:
    return 2
...
def install_freight_package() -> None:
  ...
  def freight_delivery(contents: dict[str, float]) -> int:
    distance = contents["distance_miles"]
    return 3 + math.ceil(distance / 500)
